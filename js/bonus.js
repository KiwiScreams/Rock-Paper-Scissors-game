...
const compLizard = document.getElementById('comp-lizard');
const compSpock = document.getElementById('comp-spock');
...
compLizard.style.display = 'none';
compSpock.style.display = 'none';
computer.style.backgroundColor = '#0000001a';
let score = 0;
function playGame(userChoice) {
    let compVariable = Math.floor(Math.random() * 5) + 1;
    let computerChoice = '';
    if (compVariable == 1) {
    ...
    else if (compVariable == 4) {
        computerChoice = 'lizard';
        setTimeout(() => {
            compLizard.style.display = 'block';
            computer.style.backgroundColor = 'transparent';
        }, 2000);
        computer.style.backgroundColor = '#0000001a';
    ...
    if (userChoice == computerChoice) {
        ...
        spock.style.pointerEvents = 'none';
        console.log(compVariable);
...
lizard.addEventListener("click", function () {
    ...
    spock.style.display = 'none';
    gameObj.style.backgroundImage = 'none';
    lizard.style.transform = 'scale(1.5)';
    text.style.display = 'flex';
    computer.style.display = 'block';
    gameObj.style.width = '700px';
    lizard.style.marginLeft = '-28px';
    playGame('lizard');
});
spock.addEventListener("click", function () {
    ...
    lizard.style.display = 'none';
    gameObj.style.backgroundImage = 'none';
    spock.style.transform = 'scale(1.5)';
    text.style.display = 'flex';
    computer.style.display = 'block';
    gameObj.style.width = '700px';
    spock.style.marginLeft = '-28px';
    playGame('spock');
});
retry.addEventListener('click', function () {
    ...
    lizard.style.transform = 'scale(1)';
    spock.style.transform = 'scale(1)';
    spock.style.margin = 'auto';
    ...
    lizard.style.pointerEvents = 'auto';
    spock.style.pointerEvents = 'auto';
})
